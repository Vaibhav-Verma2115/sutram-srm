...
st.sidebar.caption("Runs the models live. For the presentation-safe viewer, "
                   "use `streamlit run app/demo.py`.")
...
if arr is not None:
    ...
    sel = {
        ...
        "ldsr": st.sidebar.checkbox("LDSR-S2 (slow, ~100 s)", False),
    }
    if sel["ldsr"]:
